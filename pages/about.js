      ...
      <div className="w-full min-h-full bg-[rgb(10,25,47)] pt-24">
        <div className="max-w-[1000px] mx-auto flex flex-col justify-center min-h-full">
          ...
          <p className="px-4 text-left sm:text-center text-2xl text-[#ccd6f6] tracking-tighter">
            Hi. I am Andi, nice to meet you. Please take a look around.
          </p>
          <p className="p-4  text-justify sm:text-justify text-[#ccd6f6] tracking-wide">
            ...
            small-businesses all the way to large enterprise corporations. I am
            implementation which includes coding and testing in my project. If
            you think we can work together on your project, although it’s still
            just an Idea. Please, don’t hesitate to contact me.
          </p>
